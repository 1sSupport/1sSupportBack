    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Configuration1C", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AskTitle_Id = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportAsk_AskTitle_AskTitle_Id",
                        column: x => x.AskTitle_Id,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportAsk_AskTitle_Id",
                schema: "dbo",
                table: "SupportAsk",
                column: "AskTitle_Id");
